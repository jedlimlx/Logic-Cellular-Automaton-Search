...
Idea by WildMyron, Code is written by Lemon41625 with additional code contributions and debugging help from Mateon1.

Example Usage:
python main.py -p 4 -dx 1 -dy 1 -x 3 -y 3 (c/4d in 3x3 bounding box)
python main.py -p 5 -dx 0 -dy 1 -x 5 -y 6 --transform "Flip|" (Glide-symmetric c/5o in 5x6 bounding box)
...
parser.add_argument("-sym", "--symmetry", help="Symmetry of the pattern. These symmetries [C1, D2|, D2-, D4+] are "
...
parser.add_argument("-pop", "--population", help="Population constraints (default: >=1)", default=">=1")
...
print("Running setup...")
grid.set_formula(force_change_lst=force_change, population_bound=args.population)
